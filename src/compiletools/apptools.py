...
# identity. Two of these have live internal callers that stay in apptools
# (compiler_identity calls canonicalize_path_for_cache_key; _has_prefix_map_flag
# reads _PREFIX_MAP_FLAG_PREFIXES) — plain import. The rest are pure
# re-exports (only consumed by external modules / docstrings), so they carry
# the redundant ``name as name`` alias to mark them as intentional re-exports
# for the F401 linter.
from compiletools.apptools_canonicalize import (
