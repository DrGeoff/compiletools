...
class TestDetectMarkerTypeCommentAware:
    """Marker detection must ignore hits inside comments.
    ...
    def _detect(self, src, exe=("main(",), test=(), lib=()):
        ...
        return _detect_marker_type(text, list(exe), list(test), list(lib), spans)
    ...
    def test_marker_in_string_literal_still_classifies(self):
        # Pinned pre-existing behavior: string literals are NOT filtered.
        # Only comments are excluded; changing this is a separate decision.
