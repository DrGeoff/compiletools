...
class BazelBackend(BuildBackend):
    ...
    def _write_build(self, graph: BuildGraph, f, base_dir: str | None = None) -> None:
        ...
        # Emit load statements for targets that exist
        ...
        # For each static library rule, aggregate into a cc_library
        ...
        # For each shared library rule, aggregate into a cc_binary with linkshared
