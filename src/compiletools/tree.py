...
def depth_first_traverse(node, pre_traverse_function=None, post_traverse_function=None, depth=0):
    ...
    for key, value in list(node.items()):
        ...
        _call_function(post_traverse_function, post_function_args, key, value, post_kwargs)
